...
var b2newWorld = function(scaleFactor, gravityVector) {
  ...
  b2world =
    new box2d.World(gravityVector, true);
...
function b2setWorld(x,y,w, h) { //x is left boundary, y is center
...
function b2getWorld() { //lower left, top right
  return new box2d.AABB(b2V(b2world.x, b2world.y+b2world.width/2), b2V(b2world.x+b2world.width, b2world.y-b2world.width/2));
}
function b2setOrigin(v) {b2world.origin = v;}
function b2getOrigin(v) {return b2world.origin;}
...
function b2Body(type, dynamic, xy, wh, props) {
  ...
  Object.defineProperties(this, { // offset from position
    "centerOfMass": {
      "get": function() {
...
b2Body.prototype.draw = function() {
  ...
  for (var fixture = this.body.getFixtureList(); fixture; fixture = fixture.getNext()) {
    if (fixture.m_image) {
      ...
      image(fixture.m_image,0,0,fixture.m_imageResize.x,fixture.m_imageResize.y,0,0);
...
b2Body.prototype.drawFixture = function(fixture) {
    ...
    if (s.m_type == 'polygon' || s.m_type == 'chain') {
      ...
      line(s.m_vertex1.x * b2scaleFactor,
...
b2Body.prototype.createJoint = function b2Joint(type, bodyB, props, anchor) {
    ...
    j = {bodyA: this.body,
        ...
        dampingRatio: props.dampingRatio,
         ...
         maxLength: props.maxLength!=undefined?b2scalexTo(props.maxLength):null,
         ...
         ratio: props.ratio,
         groundAnchorA: props.groundAnchorA?b2scaleTo(props.groundAnchorA):b2V(0,0),
         groundAnchorB: props.groundAnchorB?b2scaleTo(props.groundAnchorB):b2V(0,0),
         ...
         upperTranslation: props.upperTranslation?b2scalexTo(props.upperTranslation):1,
         lowerTranslation: props.lowerTranslation?b2scalexTo(props.lowerTranslation):1,
         angularOffset: props.angularOffset,
         joint1: props.joint1,
         joint2: props.joint2,
         correctionFactor: props.correctionFactor,
         linearOffset: props.linearOffset?b2scaleTo(props.linearOffset):b2V(0,0),
        };
    if (anchor) {
      j.localAnchorA = bodyA.body.getLocalPoint(b2scaleTo(anchor));
      j.localAnchorB = bodyB.body.getLocalPoint(b2scaleTo(anchor));
    } else {
        j.localAnchorA = props.localAnchorA ? b2scaleTo(props.localAnchorA) : b2V(0,0);
      j.localAnchorB = props.localAnchorB ? b2scaleTo(props.localAnchorB) : b2V(0,0);
    }
    if (type=='distance') {
...
var b2queryAABB = (function () {
  ...
  def.query = function (aabb, search) {
    reset(search);
    aabbc = new planck.AABB(aabb.lowerBound.mul(1/b2scaleFactor),
